...
class TranslateApp:
    ...
    def save_config(self):
        try:
            ...
            # None değerlerini kontrol et ve düzelt
            if config['popup_position'] is None:
                config['popup_position'] = {"x": 100, "y": 100}
            if config['popup_size'] is None:
                config['popup_size'] = {"width": 400, "height": 300}
    ...
    def show_translate_popup(self, original_text, translated_text):
        ...
        # Orijinal metin kutusu (sesli okuma butonunu kaldır)
        ...
        # Çeviri metni kutusu (sesli okuma butonunu kaldır)
